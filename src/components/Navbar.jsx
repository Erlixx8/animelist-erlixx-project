                    ...
                    {navLinks.map((item) => {
                        ...
                        return (
                            <Link
                                key={item.name}
                                to={item.path}
                                className={`text-xs font-bold uppercase tracking-widest transition-all hover:text-yellow-500 relative py-1 ${isActive ? 'text-yellow-500' : 'text-gray-400'
                                    }`}
                            >
                                {item.name}
                                {isActive && (
                    ...
                    {navLinks.map((item) => {
                        ...
                        return (
                            <Link
                                key={item.name}
                                to={item.path}
                                className={`w-full text-center py-3 text-sm font-black uppercase tracking-widest transition-all ${isActive
